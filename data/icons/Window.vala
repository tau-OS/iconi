...
public class IconMakerWindow : He.ApplicationWindow {
	...
	private void setup_ui () {
		...
		grid_preview_picture = create_icon_picture (ICON_GRID_DARK);
	...
	private void update_grid_preview_icon () {
		...
		string icon_name = model.grid_overlay_variant == GridOverlayVariant.DARK ? ICON_GRID_DARK : ICON_GRID_LIGHT;
